---
title: "Xerox: ConnectKey printers and MFPs"
description: "Xerox ConnectKey printers and MFPs and the Microsoft 365 SMTP AUTH shutdown: some models or versions, with a link to the vendor's own statement and what to do if firmware is not an option."
---
...
# Xerox ConnectKey printers and MFPs: OAuth 2.0 and Microsoft 365 SMTP AUTH
