---
title: "Veeam: Backup for Microsoft 365 and related"
description: "Veeam Backup for Microsoft 365 and related products and the Microsoft 365 SMTP AUTH shutdown: some models or versions, with a link to the vendor's own statement and what to do if firmware is not an option."
---
...
# Veeam Backup for Microsoft 365 and related products: OAuth 2.0 and Microsoft 365 SMTP AUTH
...
- [What the error message means](../ERROR-MESSAGES.md) — if the Veeam device is reporting a code rather than a sentence
