---
title: "Canon: Maxify MB2755"
description: "Canon Maxify MB2755 and the Microsoft 365 SMTP AUTH shutdown: no oauth for this purpose, with a link to the vendor's own statement and what to do if firmware is not an option."
---
...
[Read the vendor's statement in full](https://github.com/msgwing/ZeroSMTP/blob/main/docs/DEVICE-CASE-STUDIES.md)  
...
- [What the error message means](../ERROR-MESSAGES.md) — if the Canon device is reporting a code rather than a sentence
