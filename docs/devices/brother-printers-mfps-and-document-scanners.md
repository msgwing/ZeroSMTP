---
title: "Brother: printers, MFPs and document scanners"
description: "Brother printers, MFPs and document scanners and the Microsoft 365 SMTP AUTH shutdown: check vendor advisory, with a link to the vendor's own statement and what to do if firmware is not an option."
---
...
# Brother printers, MFPs and document scanners: OAuth 2.0 and Microsoft 365 SMTP AUTH
...
[Read the vendor's statement in full](https://support.brother.com/g/b/oscontents.aspx?c=us&lang=en&ossid=42)  
...
- [What the error message means](../ERROR-MESSAGES.md) — if the Brother device is reporting a code rather than a sentence
