---
title: "Microsoft: Dynamics NAV / Business Central"
description: "Microsoft Dynamics NAV / Business Central and the Microsoft 365 SMTP AUTH shutdown: some models or versions, with a link to the vendor's own statement and what to do if firmware is not an option."
---
...
# Microsoft Dynamics NAV / Business Central: OAuth 2.0 and Microsoft 365 SMTP AUTH
...
[Read the vendor's statement in full](https://www.innovia.com/blog/microsoft-to-retire-basic-auth-smtp-for-exchange-online-what-bc-nav-users-need-to-know)  
